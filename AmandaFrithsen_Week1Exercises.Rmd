...
# Method 1: Uses a similar approach to the pair programming exercise at the end of variable_usage

matching_indices_1 <- order(test_vector,decreasing=FALSE)[logical_vector]
matching_indices_1

index <- order(test_vector,decreasing=FALSE)
index[logical_vector]

#Method 2: Uses the which() function; since this was not using slicing, I did not think it met the requirements.  However, it felt like a more efficient way to return the indices that had matches.

matching_indices_2 <- which(logical_vector)
matching_indices_2
```
